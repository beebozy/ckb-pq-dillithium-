...
function hashTypeToByte(hashType) {
    if (hashType === "data") {
        return 0;
    }
    if (hashType === "type") {
...
export function encodeCkbAddress(script, network) {
...
export function decodeCkbAddress(address) {
...
export function scriptId(script) {
